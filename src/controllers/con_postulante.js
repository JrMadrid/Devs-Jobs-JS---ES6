...
const usrPostuController = {
  createusrPostu: (req, res) => {
    const usrPostuName = req.body.nombre; const usrPostuCorreo = req.body.correo; const usrPostuClave = req.body.clave;
    connection.query('INSERT INTO usr_postu (nickname,correo,password) VALUES (?,?,?)', [usrPostuName, usrPostuCorreo, usrPostuClave], (error, results, fields) => {
      ...
      } else { res.redirect('/postulante/usuario'); }// Si la inserción fue exitosa, devolver una respuesta exit
    });
  },
  getusrPostu: (req, res) => { // Método para obtener todas los postulantes
  ...
  login: (req, res) => {
    const usrPostuName = req.body.nombre; const usrPostuClave = req.body.clave;
  ...
  createPostulante: (req, res) => {
    const NumeroIdentidad = req.body.numid; const Nombres = req.body.nombre; const Apellidos = req.body.apellido;
    const CorreoElectronico = req.body.correo; const Telefono = req.body.telefono; const FechaNacimiento = req.body.fechan;
    const Sexo = req.body.sexo; const Direccion = req.body.direccion; const Estadop = req.body.estado;
    const Area = req.body.area; const Descripcion = req.body.descripcion; const nickname = req.body.nickname;
  ...
  createContrato: (req, res) => {
    const ContratoID = req.body.contratoid; const VacanteID = req.body.vacanteid;
    const NumeroIdentidad = req.body.numid; const TipoContrato = req.body.tipoc;
    const FechaInicio = req.body.fechai; const FechaVencimiento = req.body.fechaf;
    const Horario = req.body.horario; const Sueldo = req.body.sueldo;
    const DiasLaborales = req.body.diasl; const DiasVacaciones = req.body.diasv;
...
export default usrPostuController;